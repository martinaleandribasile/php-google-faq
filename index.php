...
$main_contents_sections = [
    ...
    [
        ...
        'text' => [
            ...
            'Puoi leggere ulteriori informazioni sulla sicurezza online, incluso come proteggere te e la tua famiglia online, <a>nel Centro Google per la sicurezza online</a>.',
...
$class_link_unactive = 'headerlinks'
...
<body>
    <header class="d-flex flex-column m-0 px-4 gap-3">
        <div class="d-flex justify-content-between">
            <div class="d-flex">
                <img src="https://www.ilpost.it/wp-content/uploads/2015/09/google-logo.jpg" alt="">
                <h4 class="d-flex align-items-center ms-3 text-black-50">Privacy e termini</h4>
            </div>
        ...
        <div class="border-bottom linkheader ">
            <ul class="d-flex p-0 m-0 gap-5">
                <?php foreach ($links_header as $link) : ?>
                    <li class="<?php if ($link['onfocus']) {
                                    echo $class_link_active;
                                } else {
                                    echo $class_link_unactive;
    ...
    <main>
        <?php foreach ($main_contents_sections as $element) { ?>
            <h3 class="mb-4 mt-5"><?php echo $element['title'] ?></h3>
            <?php foreach ($element['text'] as $content) {
            ?>
